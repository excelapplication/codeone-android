...
public class SalesOrderDetail {
    ...
    @ColumnInfo(name = "ORD_PARENT_COCD")
    private String ord_parent_cocd;
    ...
    public String getOrd_parent_cocd() {
        return ord_parent_cocd;
    }

    public void setOrd_parent_cocd(String ord_parent_cocd) {
        this.ord_parent_cocd = ord_parent_cocd;
    }
